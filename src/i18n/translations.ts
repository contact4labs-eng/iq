export const translations = {
  ...
  "automation.supplier_contains": { el: "Προμηθευτής περιέχει", en: "Supplier contains" },
  "automation.amount_above": { el: "Ποσό πάνω από", en: "Amount above" },
  "automation.set_category": { el: "Ορισμός κατηγορίας", en: "Set category" },
  "automation.auto_approve": { el: "Αυτόματη έγκριση", en: "Auto-approve" },
  "automation.on_upload": { el: "Κατά ανέβασμα", en: "On upload" },
  "automation.on_extract": { el: "Κατά εξαγωγή", en: "On extraction" },
  "automation.notify_team": { el: "Ειδοποίηση ομάδας", en: "Notify team" },
  "automation.flag_review": { el: "Σημαίωση για έλεγχο", en: "Flag for review" },
} as const;
